...
const Color lightGreenDot = Color(0xFFC7D3B5); // Noktalar için biraz daha açık bir ton kullandım.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Colors.black), // Siyah geri oku
          onPressed: () {
      ...
      body: SafeArea( // İçeriğin, telefonun çentiği (notch) gibi alanlara girmesini engeller
        child: Padding(
          ...
          // BURADA YENİ ClipRRect widget'ı ekliyoruz
            ClipRRect(
            borderRadius: BorderRadius.circular(140.0), // Kenar yuvarlama miktarı (deneyerek ayarlayabilirsiniz)
              child : Image.asset(
                'assets/images/onboarding2.png',
                height: MediaQuery.of(context).size.height * 0.40, // Ekran yüksekliğinin %40'ı
                fit: BoxFit.contain,
              ),),
              ...
              OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: const BorderSide(color: primaryGreen, width: 2.0), // Yeşil çerçeve
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12.0),
                  ),
                  elevation: 0,
